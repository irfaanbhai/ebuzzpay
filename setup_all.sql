-- ============================================================
-- ZPay — consolidated database setup (generated)
-- Apply order: base schema -> ban column -> extra RPCs
-- Safe to re-run (idempotent: create-if-not-exists / create-or-replace).
-- ============================================================

-- ===== [1/5] complete_setup.sql (tables, RLS, policies, core functions) =====
...
-- ===== [2/5] ban_user_setup.sql (profiles.is_banned + toggle_ban_user) =====
...
-- ===== [3/5] admin_tools_pagination.sql (get_all_tools paginated) =====
...
-- ===== [4/5] check_daily_limit.sql (get_daily_tool_count) =====
...
-- ===== [5/5] check_duplicate_upi.sql (check_upi_exists) =====
